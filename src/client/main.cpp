    ...
    while (1)
    {
        ...
        else
        {
            ...
            if (msgtype == ONE_CHAT_MSG)
                cout << "time:" << js["time"] << "[" << js["id"] << "]" << js["name"] << "说:" << js["msg"] << endl;
            else if (msgtype == GROUP_CHAT_MSG)
            {
                cout << "群组" << "[" << js["groupid"] << "]:" << "time:" << js["time"] << "[" << js["userid"] << "]" << js["name"] << "说:" << js["msg"] << endl;
            }
        }
    }
}
